...
if(order){
  showAlert({msg: 'Your order is complete', type:'success'})
  clearCart();
  history.push('/')
  return;
} else{
      ...
      <form className="checkout-form">
        ...
        <div className="stripe-input">
          ...
          <p className="stripe-info">
            ...
            <br />
            enter any 4 digits for the zip code
            <br />
...
const StripeWrapper = () => {
  return (
    <StripeProvider apiKey="pk_test_51HeKLOKfokUuLYj6dWk2LwaQ2Q6tvdFYkqDXZc5o3LOBN6zIYiui6Q4Cjwx4tEW2yQsdmoXNokHROIVbo335HiiL0024m8Xzkk">
      <Elements>
        <CardForm></CardForm>
      </Elements>
    </StripeProvider>
